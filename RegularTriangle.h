...
private:
 /**
     ...
     * @details Хранит координаты (x1, y1) первой вершины.
     *          Используется для вычисления сторон, площади,
     *          периметра и радиуса описанной окружности.
     */
    Point m_p1;
     /**
     * @brief Вторая вершина треугольника.
     * @details Хранит координаты (x2, y2) второй вершины.
     *          Совместно с m_p1 и m_p3 определяет геометрию
     *          правильного треугольника.
     */
    Point m_p2; 
    /**
     * @brief Третья вершина треугольника.
     * @details Хранит координаты (x3, y3) третьей вершины.
     *          Замыкает фигуру и участвует во всех геометрических
     *          расчётах класса.
     */
    Point m_p3; 
